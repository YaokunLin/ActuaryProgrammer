...
urlpatterns = [
    ...
    path(
        "<practice_telecom_id>/<call_subscription_id>/call-subscription-receiver/", netsapiens_call_subscription_event_receiver_view, name="call-subscription-event-receiver"
