...
PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED = os.getenv("PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED", "dev-ringcentral-create-call-record")
PUBSUB_TOPIC_PATH_RINGCENTRAL_CALL_DISCONNECTED_PROJECT_ID = os.getenv("PUBSUB_TOPIC_PATH_RINGCENTRAL_CALL_DISCONNECTED_PROJECT_ID", PROJECT_ID)
...
if PUBLISHER_IS_ENABLED:
    ...
    PUBSUB_TOPIC_PATH_RINGCENTRAL_CREATE_CALL_RECORD = PUBLISHER.topic_path(
        PUBSUB_TOPIC_PATH_RINGCENTRAL_CALL_DISCONNECTED_PROJECT_ID, PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED
    )
