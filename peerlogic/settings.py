...
CALL_AUDIO_BUCKET_NAME = os.getenv("CALL_AUDIO_BUCKET_NAME")
CALL_AUDIO_PARTIAL_BUCKET_NAME = os.getenv("CALL_AUDIO_PARTIAL_BUCKET_NAME")
CALL_TRANSCRIPT_BUCKET_NAME = os.getenv("CALL_TRANSCRIPT_BUCKET_NAME")
CALL_TRANSCRIPT_PARTIAL_BUCKET_NAME = os.getenv("CALL_TRANSCRIPT_PARTIAL_BUCKET_NAME")
...
PUBSUB_TOPIC_ID_AUDIO_PARTIAL_READY = os.getenv("PUBSUB_TOPIC_ID_AUDIO_PARTIAL_READY", "dev-audio_partial_ready")
PUBSUB_TOPIC_ID_CALL_AUDIO_SAVED = os.getenv("PUBSUB_TOPIC_ID_CALL_AUDIO_SAVED", "dev-call_audio_saved")
PUBSUB_TOPIC_ID_CALL_TRANSCRIPT_READY = os.getenv("PUBSUB_TOPIC_ID_CALL_TRANSCRIPT_READY", "dev-transcript_ready")
...
PUBSUB_TOPIC_ID_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL = os.getenv("PUBSUB_TOPIC_ID_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL", "dev-netsapiens-cdr_linked_to_call_partial")


PUBSUB_TOPIC_PATH_NETSAPIENS_LEG_B_FINISHED = PUBLISHER.topic_path(PROJECT_ID, PUBSUB_TOPIC_ID_NETSAPIENS_LEG_B_FINISHED)
PUBSUB_TOPIC_PATH_NETSAPIENS_CDR_SAVED = PUBLISHER.topic_path(PROJECT_ID, PUBSUB_TOPIC_ID_NETSAPIENS_CDR_SAVED)
PUBSUB_TOPIC_PATH_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL = PUBLISHER.topic_path(PROJECT_ID, PUBSUB_TOPIC_ID_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL)
PUBSUB_TOPIC_PATH_AUDIO_PARTIAL_READY = PUBLISHER.topic_path(PROJECT_ID, PUBSUB_TOPIC_ID_AUDIO_PARTIAL_READY)
PUBSUB_TOPIC_PATH_CALL_AUDIO_SAVED = PUBLISHER.topic_path(PROJECT_ID, PUBSUB_TOPIC_ID_CALL_AUDIO_SAVED)
PUBSUB_TOPIC_PATH_CALL_TRANSCRIPT_READY = PUBLISHER.topic_path(PROJECT_ID, PUBSUB_TOPIC_ID_CALL_TRANSCRIPT_READY)
