...
# NexHealth
PUBSUB_TOPIC_ID_NEXHEALTH_FOO = env("PUBSUB_TOPIC_ID_NEXHEALTH_FOO", cast=str, default="dev-foo")
PUBSUB_TOPIC_ID_NEXHEALTH_FOO_PROJECT_ID = env("PUBSUB_TOPIC_ID_NEXHEALTH_FOO_PROJECT_ID", cast=int, default=PROJECT_ID)
...
if PUBLISHER_IS_ENABLED:
    ...
    # NexHealth
    PUBSUB_TOPIC_PATH_NEXHEALTH_FOO = PUBLISHER.topic_path(PUBSUB_TOPIC_ID_NEXHEALTH_FOO_PROJECT_ID, PUBSUB_TOPIC_ID_NEXHEALTH_FOO)
    ...
    # NexHealth
    PUBSUB_TOPIC_PATH_NEXHEALTH_FOO = None
