...
# NexHealth
PUBSUB_TOPIC_ID_NEXHEALTH_INITIALIZE_PRACTICE = env("PUBSUB_TOPIC_ID_NEXHEALTH_INITIALIZE_PRACTICE", cast=str, default="dev-nexhealth_initialize_practice")
PUBSUB_TOPIC_ID_NEXHEALTH_INITIALIZE_PRACTICE_PROJECT_ID = env("PUBSUB_TOPIC_ID_NEXHEALTH_INITIALIZE_PRACTICE_PROJECT_ID", cast=int, default=PROJECT_ID)
...
if PUBLISHER_IS_ENABLED:
    ...
    # NexHealth
    PUBSUB_TOPIC_PATH_NEXHEALTH_INITIALIZE_PRACTICE = PUBLISHER.topic_path(
        PUBSUB_TOPIC_ID_NEXHEALTH_INITIALIZE_PRACTICE_PROJECT_ID, PUBSUB_TOPIC_ID_NEXHEALTH_INITIALIZE_PRACTICE
    )
    ...
    # NexHealth
    PUBSUB_TOPIC_PATH_NEXHEALTH_INITIALIZE_PRACTICE = None
