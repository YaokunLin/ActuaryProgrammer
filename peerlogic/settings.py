...
PUBSUB_TOPIC_ID_NETSAPIENS_CDR_SAVED_PROJECT_ID = os.getenev("PUBSUB_TOPIC_ID_NETSAPIENS_CDR_SAVED_PROJECT_ID", PROJECT_ID)
...
PUBSUB_TOPIC_ID_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL_PROJECT_ID = os.getenv(
    "PUBSUB_TOPIC_ID_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL_PROJECT_ID", PROJECT_ID
)
...
if PUBLISHER_IS_ENABLED:
    ...
    PUBSUB_TOPIC_PATH_NETSAPIENS_LEG_B_FINISHED = PUBLISHER.topic_path(PUBSUB_TOPIC_ID_NETSAPIENS_LEG_B_FINISHED_PROJECT_ID, PUBSUB_TOPIC_ID_NETSAPIENS_LEG_B_FINISHED)
    ...
    PUBSUB_TOPIC_PATH_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL = PUBLISHER.topic_path(PUBSUB_TOPIC_ID_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL_PROJECT_ID, PUBSUB_TOPIC_ID_NETSAPIENS_CDR_LINKED_TO_CALL_PARTIAL)
    PUBSUB_TOPIC_PATH_CALL_AUDIO_PARTIAL_SAVED = PUBLISHER.topic_path(PUBSUB_TOPIC_ID_CALL_AUDIO_PARTIAL_SAVED_PROJECT_ID, PUBSUB_TOPIC_ID_CALL_AUDIO_PARTIAL_SAVED)
