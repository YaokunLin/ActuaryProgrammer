...
# Peerlogic Voice Netsapiens IDs, used by customers and cloud functions
PEERLOGIC_NETSAPIENS_VOIP_PROVIDER_ID = os.getenv("PEERLOGIC_NETSAPIENS_VOIP_PROVIDER_ID", "drFoXEnEwrN28Gowp3CoRN")
PEERLOGIC_NETSAPIENS_API_CREDENTIALS_ID = os.getenv("PEERLOGIC_NETSAPIENS_API_CREDENTIALS_ID", "UkoK7kn7J6FEdGAtLBTsr4")
IS_STAFF_TELECOM_DOMAIN = os.getenv("IS_STAFF_TELECOM_DOMAIN", "Peerlogic")

# Test environment (dev and stage) practice ids
TEST_NETSAPIENS_PRACTICE_ID = os.getenv("TEST_NETSAPIENS_PRACTICE_ID", "bpQY6L8zE96SVqCUXTPYq3")
TEST_NETSAPIENS_PRACTICE_TELECOM_ID = os.getenv("TEST_NETSAPIENS_PRACTICE_TELECOM_ID", "N8UBbUVQ4nM3BUZPcZUBdN")
TEST_JIVE_PRACTICE_ID = os.getenv("TEST_JIVE_PRACTICE_ID", "4PFqTAD7jpq23TR7bDhxm7")
...
# Shared, downstream Peerlogic Audio Processing
...
# Jive
PUBSUB_TOPIC_ID_JIVE_LEG_B_FINISHED = os.getenv("PUBSUB_TOPIC_ID_JIVE_LEG_B_FINISHED", "dev-jive-leg_b_finished")
PUBSUB_TOPIC_ID_JIVE_LEG_B_FINISHED_PROJECT_ID = os.getenv("PUBSUB_TOPIC_ID_JIVE_LEG_B_FINISHED_PROJECT_ID", PROJECT_ID)
...
# RingCentral
PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED = os.getenv("PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED", "dev-ringcentral-call_disconnected")
PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED_PROJECT_ID = os.getenv("PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED_PROJECT_ID", PROJECT_ID)
...
# NexHealth
PUBSUB_TOPIC_ID_NEXHEALTH_INGEST_PRACTICE: str = env("PUBSUB_TOPIC_ID_NEXHEALTH_INGEST_PRACTICE", cast=str, default="dev-nexhealth_ingest_practice")
PUBSUB_TOPIC_ID_NEXHEALTH_INGEST_PRACTICE_PROJECT_ID: int = env("PUBSUB_TOPIC_ID_NEXHEALTH_INGEST_PRACTICE_PROJECT_ID", cast=int, default=PROJECT_ID)
PUBSUB_TOPIC_ID_NEXHEALTH_SYNC_PRACTICE: str = env("PUBSUB_TOPIC_ID_NEXHEALTH_SYNC_PRACTICE", cast=str, default="dev-nexhealth_sync_practice")
PUBSUB_TOPIC_ID_NEXHEALTH_SYNC_PRACTICE_PROJECT_ID: int = env("PUBSUB_TOPIC_ID_NEXHEALTH_SYNC_PRACTICE_PROJECT_ID", cast=int, default=PROJECT_ID)
...
if PUBLISHER_IS_ENABLED:
    ...
    # Shared Peerlogic Audio Processing
    ...
    # Jive
    PUBSUB_TOPIC_PATH_JIVE_LEG_B_FINISHED = PUBLISHER.topic_path(PUBSUB_TOPIC_ID_JIVE_LEG_B_FINISHED_PROJECT_ID, PUBSUB_TOPIC_ID_JIVE_LEG_B_FINISHED)
    ...
    # RingCentral
    PUBSUB_TOPIC_PATH_RINGCENTRAL_CALL_DISCONNECTED = PUBLISHER.topic_path(
        PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED_PROJECT_ID, PUBSUB_TOPIC_ID_RINGCENTRAL_CALL_DISCONNECTED
    )
    PUBSUB_TOPIC_PATH_RINGCENTRAL_CALL_LEG_SAVED = PUBLISHER.topic_path(
    ...
    PUBSUB_TOPIC_PATH_NEXHEALTH_SYNC_PRACTICE = PUBLISHER.topic_path(
        PUBSUB_TOPIC_ID_NEXHEALTH_SYNC_PRACTICE_PROJECT_ID, PUBSUB_TOPIC_ID_NEXHEALTH_SYNC_PRACTICE
    )
    ...
    # Jive
    PUBSUB_TOPIC_PATH_JIVE_LEG_B_FINISHED = None
    ...
    PUBSUB_TOPIC_PATH_NEXHEALTH_SYNC_PRACTICE = None
...
JIVE_BUCKET_NAME = os.getenv("JIVE_BUCKET_NAME", "goto-development-recordings")
...
TEST_API_CLIENT_ROOT_URL = TEST_API_CLIENT_ROOT_URL.strip("/")
