...
PUBSUB_TOPIC_ID_TRANSCRIPT_PARTIAL_READY = os.getenv("PUBSUB_TOPIC_ID_TRANSCRIPT_PARTIAL_READY", "dev-transcript_partial_ready")
...
PUBSUB_TOPIC_PATH_TRANSCRIPT_PARTIAL_READY = PUBLISHER.topic_path(PROJECT_ID, PUBSUB_TOPIC_ID_TRANSCRIPT_PARTIAL_READY)
