...
PUBSUB_TOPIC_ID_RINGCENTRAL_CREATE_CALL_RECORD = os.getenv("PUBSUB_TOPIC_ID_RINGCENTRAL_CREATE_CALL_RECORD", "dev-ringcentral-create-call-record")
PUBSUB_TOPIC_PATH_RINGCENTRAL_CREATE_CALL_RECORD_PROJECT_ID = os.getenv("PUBSUB_TOPIC_PATH_RINGCENTRAL_CREATE_CALL_RECORD_PROJECT_ID", PROJECT_ID)

PUBSUB_TOPIC_ID_RINGCENTRAL_GET_CALL_AUDIO = os.getenv("PUBSUB_TOPIC_ID_RINGCENTRAL_GET_CALL_AUDIO", "dev-ringcentral-get-call-audio")
PUBSUB_TOPIC_PATH_RINGCENTRAL_GET_CALL_AUDIO_PROJECT_ID = os.getenv("PUBSUB_TOPIC_PATH_RINGCENTRAL_GET_CALL_AUDIO _PROJECT_ID", PROJECT_ID)
...
if PUBLISHER_IS_ENABLED:
    ...
    PUBSUB_TOPIC_PATH_RINGCENTRAL_CREATE_CALL_RECORD = PUBLISHER.topic_path(
        PUBSUB_TOPIC_PATH_RINGCENTRAL_CREATE_CALL_RECORD_PROJECT_ID, PUBSUB_TOPIC_ID_RINGCENTRAL_CREATE_CALL_RECORD
    )
    PUBSUB_TOPIC_PATH_RINGCENTRAL_GET_CALL_AUDIO = PUBLISHER.topic_path(
        PUBSUB_TOPIC_PATH_RINGCENTRAL_GET_CALL_AUDIO_PROJECT_ID, PUBSUB_TOPIC_ID_RINGCENTRAL_GET_CALL_AUDIO
    )
    ...
    PUBSUB_TOPIC_PATH_RINGCENTRAL_CREATE_CALL_RECORD = None
    PUBSUB_TOPIC_PATH_RINGCENTRAL_GET_CALL_AUDIO = None
