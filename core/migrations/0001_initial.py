# Generated by Django 3.2.10 on 2021-12-09 01:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='practices',
            field=models.ManyToManyField(blank=True, help_text='The practices this user belongs to. A user will get all permissions granted to each of their practices.', related_name='user_set', related_query_name='user', to='core.Practice', verbose_name='practices'),
        ),
        migrations.AddField(
            model_name='user',
