...
class Contact(AuditTrailModel):
    ...
    phone_mobile = PhoneNumberField(db_index=True, default=None)
    phone_home = PhoneNumberField(db_index=True, blank=True, default=None)
    phone_work = PhoneNumberField(db_index=True, blank=True, default=None)
    phone_fax = PhoneNumberField(blank=True, default=None)
