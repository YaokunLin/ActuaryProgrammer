...
class Contact(AuditTrailModel):
    ...
    phone_mobile = PhoneNumberField(db_index=True)
    phone_home = PhoneNumberField(db_index=True, null=True, default=None)
    phone_work = PhoneNumberField(db_index=True, null=True, default=None)
