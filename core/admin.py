...
from .models import Agent, Client, Patient, Practice, PracticeGroup, PracticeTelecom, User, UserPatient, UserTelecom, VoipProvider
...
admin.site.register(PracticeGroup, PracticeGroupAdmin)
