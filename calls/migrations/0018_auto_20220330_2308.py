    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('call', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purposes', to='calls.call', verbose_name='Purpose of the call')),
                ('call_outcome', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='source_purposes', to='calls.calloutcome', verbose_name='The result of the attempted purpose')),
        ...
        migrations.AddField(
            ...
            name='call_outcome_reason',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='source_outcomes', to='calls.calloutcomereason', verbose_name="The outcome from the call's purpose"),
        ),
        migrations.AddField(
            model_name='calloutcome',
            name='created_by',
