...
class Call(AuditTrailModel):
    ...
    sip_caller_extension = models.CharField(max_length=60, blank=True, db_index=True)
    sip_caller_number = PhoneNumberField(blank=True, db_index=True)
    sip_caller_name = models.CharField(max_length=255, blank=True)
    sip_callee_extension = models.CharField(max_length=60, blank=True, db_index=True)
    sip_callee_number = PhoneNumberField(blank=True, db_index=True)
