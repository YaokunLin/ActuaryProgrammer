...
class CallOutcomeReasonViewset(viewsets.ModelViewSet):
    ...
    filter_fields = ["call_outcome_reason_type"]
...
class CallOutcomeViewset(viewsets.ModelViewSet):
    ...
    filter_fields = ["call_outcome_type", "call_outcome_reason"]
...
class CallPurposeViewset(viewsets.ModelViewSet):
    ...
    filter_fields = ["call_outcome__call_outcome_type", "call_outcome__call_outcome_type"]
