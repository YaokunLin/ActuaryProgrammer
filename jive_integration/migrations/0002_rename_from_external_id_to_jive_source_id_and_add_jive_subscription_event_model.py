# Generated by Django 3.2.15 on 2022-09-26 21:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_id', models.CharField(max_length=36)),
                ('old_id', models.CharField(max_length=36)),
                ('new_id', models.CharField(max_length=36)),
                ('entity_id', models.CharField(max_length=128)),
                ('data_leg_id', models.CharField(max_length=36)),
